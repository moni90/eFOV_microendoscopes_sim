...
if ispc
    save_name = [ground_truth_list.folder '\' ground_truth_list.folder(end-9:end) '_SNR' num2str(thr_snr_LENS) '_CaImAn_segmentation.mat'];
elseif isunix
    save_name = [ground_truth_list.folder '/' ground_truth_list.folder(end-10:end) '_SNR' num2str(thr_snr_LENS*100) '_CaImAn_segmentation.mat'];
end
